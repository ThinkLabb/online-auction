...
export function OrderCompletionView({ order: orderProp }: { order: Order }) {
  ...
  // ... (Remainder of the return/render logic remains the same as your original code) ...
  // NOTE: For brevity, I am not repeating the huge Return block here unless you need it.
  // Just make sure to use the handlers defined above.
  
  // ... Paste your render logic here ...
