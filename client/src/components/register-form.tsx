            ...
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex flex-col sm:flex-row gap-2'> {/* Thêm flex-col trên mobile, flex-row trên sm+ */}
                        ...
                        >
                            {loadingSendCode ? <ClipLoader loading={loadingSendCode} size={20} color='white' /> : 'Send Code'}
                        </button>
                    </div>
                ...
                {/* 3. OTP */}
                <div className='flex flex-col gap-2'>
                    <label htmlFor="otp" className="font-semibold text-gray-900">OTP</label>
                    <input 
                        type="number" 
                        id="otp" 
                        placeholder='123456' 
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <input 
                        ...
                        className='w-full px-3 py-2 border rounded-md focus:outline-2 focus:outline-[#8D0000]' 
                    />
                    {!errors.password && <p className="text-xs text-gray-500">At least 8 characters with uppercase, lowercase, number, and special character</p>}
