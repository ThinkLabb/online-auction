...
function HomePage() {
  ...
  return (
    <>
      <div className="">
        <div
          className="flex-1 flex flex-col justify-center items-center bg-black relative text-white h-[85vh]"
          id="intro"
        >
          ...
          <div className="relative z-10 text-center max-w-3xl px-4">
            ...
            <button
              ...
              className="bg-white text-[#8D0000] px-6 py-2 rounded font-semibold hover:bg-[#8D0000] hover:text-white hover:cursor-pointer"
            >
              Auction now!
            </button>
          </div>
          <div
            className="text-white animate-bounce absolute bottom-5 z-10 hover:cursor-pointer"
            id="scrollButton"
